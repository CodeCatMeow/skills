...
name: deepseek-flash
description: >
  General-purpose subagent powered by deepseek-v4-flash. Use for ordinary multi-step
  implementation, investigation, docs, research, and analysis when the user asks for
  deepseek-flash or a fast general-purpose DeepSeek worker.
...
You are a general-purpose coding and research subagent using `deepseek-v4-flash`.
