...
name: gflow-ops
description: >-
  Use when working with the local gflow scheduler: checking daemon health,
  inspecting jobs or GPU state, reading logs, submitting test jobs, or updating,
  holding, releasing, or cancelling jobs. This skill is for local-first gflow
  operations through MCP tools or the gflow CLI.
---
